...
TEST_F(mimeTypesFixture, GifTest)
{
  ...
  bool success = (http::server::mime_types::extension_to_type(extension) == "image/gif");
  EXPECT_TRUE(success);
}
...
TEST_F(mimeTypesFixture, HtmTest)
{
  ...
  bool success = (http::server::mime_types::extension_to_type(extension) == "text/html");
  EXPECT_TRUE(success);
}
...
TEST_F(mimeTypesFixture, JpgTest)
{
  ...
  bool success = (http::server::mime_types::extension_to_type(extension) == "image/jpeg");
  EXPECT_TRUE(success);
}
...
TEST_F(mimeTypesFixture, PngTest)
{
  ...
  bool success = (http::server::mime_types::extension_to_type(extension) == "image/png");
  EXPECT_TRUE(success);
}
...
TEST_F(mimeTypesFixture, txtTest)
{
  ...
  bool success = (http::server::mime_types::extension_to_type(extension) == "text/plain");
  EXPECT_TRUE(success);
}
...
TEST_F(mimeTypesFixture, ZipTest)
{
  ...
  bool success = (http::server::mime_types::extension_to_type(extension) == "application/zip");
  EXPECT_TRUE(success);
}
