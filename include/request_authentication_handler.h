...
{
public:
  request_authentication_handler(std::string location, std::string request_url,std::string root_, std::string data_path, std::string signup_, std::string login_, user_profile profile);
